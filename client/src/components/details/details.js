                ...
                <div className={styles.sortImage2}>
                  <div className={styles.insideBox}>
                    ...
                    <div className={styles.sortSelect}>
                      <select
                        onChange={(event) =>
                          handleSelect(product.Id, event.target.value)
                        }
                    ...
                    {product.stock === 0 ? (
                      <div className={styles.sortButton}>
                        ...
                        >
                          <CancelPresentation className={styles.cartIcon} />
                        </button>
                      </div>
                    ) : (
                      <div className={styles.sortButton}>
                        {typeof userCart !== String &&
                        !userCart.find((item) => item.Id === product.Id) ? (
                          <button
                            onClick={() =>
                              handleCartAdd(
                                product.name,
                            ...
                            className={styles.buttonBuy}
                          >
                            <CartPlusFill className={styles.cartIcon} />
                          </button>
                        ) : (
                          <button
                            ...
                            className={styles.buttonBuy}
                          >
                            <CartDashFill className={styles.cartIcon} />
                          </button>
                        )}
                      </div>
                    )}
