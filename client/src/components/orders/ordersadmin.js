                      ...
                      <div className={stylesOrders.sortButtons}>
                        <div className={stylesOrders.eachButton}>
                          ...
                          item.status !== "Canceled" ? (
                            <button
                              onClick={() =>
                                handleSubmitSend(item.Id, item.email)
                              }
                              className={stylesOrders.buttons}
                            >
                              Send
                            </button>
                          ) : (
                            <button className={stylesOrders.buttonsDisabled}>
                              Send
                            </button>
                          )}
                        </div>
                        <div className={stylesOrders.eachButton}>
                          {item.status !== "Canceled" ? (
                            <button
                              onClick={() =>
                                handleSubmitCancel(item.Id, item.email)
                              }
                              className={stylesOrders.buttons}
                            >
                              Cancel
