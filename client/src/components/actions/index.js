...
export const GETCATEGORIES = () => {
  return async (dispatch) => {
    return await axios
      .get(URL + "/Products/subcategories")
      .then((response) => response.data)
      .then((data) => {
...
export const GETORDERBYID = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Orders/orderbyId", {
        Id: info,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: GET_ORDER_BYID, payload: data }));
  };
};
...
export const GETORDERBYUSER = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Orders/orderbyuser", {
        email: info,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: GET_ORDER_BYUSER, payload: data }));
  };
};
...
export const PRODUCTSBYID = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Products/byId", {
        Id: info,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: PRODUCTS_ID, payload: data }));
  };
};
...
export const GETCART = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Users/getcart", {
        email: info,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: GET_CART, payload: data }));
  };
};
...
export const CLEANCART = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Users/cleancart", {
        email: info,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: CLEAN_CART, payload: data }));
  };
};
...
export const ADDMORE = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Users/addquantity", {
        cart: info.cart,
        email: info.email,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: ADD_MORE, payload: data }));
  };
};
...
export const LESSMORE = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Users/lessquantity", {
        email: info.email,
        cart: info.cart,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: LESS_MORE, payload: data }));
  };
};
...
export const ADDWISH = (info) => {
  return async (dispatch) => {
    return await axios
      ...
      .then((response) => response.data)
      .then((data) => dispatch({ type: ADD_WISH, payload: data }));
  };
};
...
export const REMOVEWISH = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Users/removewish", {
        email: info.email,
        Id: info.Id,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: REMOVE_WISH, payload: data }));
  };
};
...
export const GETWISH = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Users/getwishlist", {
        email: info,
      })
      .then((response) => response.data)
      .then((data) => dispatch({ type: GET_WISHLIST, payload: data }));
  };
};
...
export const REMOVECOMMENT = (info) => {
  return async (dispatch) => {
    return await axios
      .post(URL + "/Products/removecomment", {
        Id: info,
      })
      .then((response) => response.data)
