                ...
                <div className={styles.addInfo}>
                  <div className={styles.titleAdd}>
                    <p className={styles.pInfo}>
                      If you want to see the administrator privileges you can
                      use the following data:
                    </p>
                  </div>
                  <div className={styles.littleBox}>
                    <button onClick={handleAdmin} className={styles.buttonInfo}>
                      adminClothbea@hotmail.com
                    </button>
                  </div>
                </div>
                  ...
                  <div className={styles.eachInput}>
                    <label class="input">
                      ...
                      <span class="input__label">
                        <Mail className={styles.iconsLogin} /> E-Mail
                      </span>
                    </label>
                  </div>
                  <div className={styles.eachInput}>
