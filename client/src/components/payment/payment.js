...
const Payment = (props) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!error) {
      await axios
        .post(URL + "/Orders/paymentcheckout", {
          Id: Id,
              ...
              <form onSubmit={handleSubmit} className={styles.form}>
                <div className={styles.eachInput}>
                  <label class="input">
                    ...
                    <span class="input__label">
                      <DocumentOnePage className={styles.iconsLogin} />
                      Name
                    </span>
                  </label>
                </div>
                ...
                <div className={styles.eachInput}>
                  <label class="input">
                    ...
                    />
                    <span class="input__label">
                      <City className={styles.iconsLogin} />
                      City
                    </span>
                  </label>
                </div>
                <div className={styles.eachInput}>
                  <label class="input">
                    ...
                    />
                    <span class="input__label">
                      <Address className={styles.iconsLogin} />
                      Address
                    </span>
                  </label>
                </div>
                <div className={styles.eachInput}>
                  <label class="input">
                    ...
                    />
                    <span class="input__label">
                      <RealEstate className={styles.iconsLogin} />
                      State
                    </span>
                  </label>
                </div>
                <div className={styles.eachInput}>
                  <label class="input">
                    ...
                    />
                    <span class="input__label">
                      <Mailbox className={styles.iconsLogin} />
                      ZIP
                    </span>
                  </label>
                </div>
                <div className={styles.Card}>
                  <div className={styles.divLabel}>
                    ...
                    <label className={styles.labelCardExample}>
                      Example: 4242 4242 4242 4242 || 12/21 || 123{" "}
                    </label>
                  </div>
