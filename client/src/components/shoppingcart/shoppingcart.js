...
const ShoppingCart = () => {
  ...
  const handeLinkToPost = () => {
    cartUser.length === 0
      ...
      : (window.location.href = `https://clothbea.netlify.app/Shipments?Total=${totalProducts}`);
  };
            ...
            <div className={styles.boxShopping}>
              <div className={styles.sortTitleShopping}>
                <p className={styles.styleTitle}>
                  These are your products {nameUser}
                </p>
              </div>
              <div
                className={
                  cartUser.length !== 0 ? styles.sortButtonClean : styles.none
                }
              >
                <button className={styles.buttonClean} onClick={handleCLean}>
                  <Trash className={styles.Trash} /> Clean cart
                </button>
              </div>
                    ...
                    <div className={styles.eachCart}>
                      ...
                      <div className={styles.sortElementCartsButton}>
                        ...
                        >
                          {" "}
                          Delete product{" "}
                          <SquaredCross className={styles.cross} />
                        </button>
                      </div>
                      ...
                      <div className={styles.sortBotton}>
                        {disabled ? (
                          ...
                          <div className={styles.eachBottonDisabeld}>
                            <button className={styles.bottonBot}>
                              <PlusCircle className={styles.plus} />
                            </button>
                          </div>
                        )}
                        ...
                        {disabled ? (
                          <div className={styles.eachBotton}>
                            <button
                              ...
                              className={styles.bottonBot}
                            >
                              <MinusCircle className={styles.plus} />
                            </button>
                          </div>
                        ) : (
                          <div className={styles.eachBottonDisabeld}>
              ...
              <div className={styles.insideBox}>
                ...
                <div className={styles.eachInside}>
                  <button
                    onClick={handeLinkToPost}
                    className={styles.bottonBuy}
                  >
                    BUY <CashRegister className={styles.cash} />
                  </button>
                </div>
              </div>
            </div>
